...
function Board (options){
  ...
  function getBestMove (board, symbol)
  {
    ...
    for (var i=0 ; i<availableMoves.length ; i++){
      // Iterates over each available move. If it finds a winning move it returns it immediately. 
      //   Otherwise it pushes a move and a score to the availableMovesAndScores array.
